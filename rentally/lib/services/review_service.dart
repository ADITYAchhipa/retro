    ...
    final listingReviews = {
      '1': [
        Review(
          ...
          userAvatar: 'https://via.placeholder.com/150/2196F3/FFFFFF?text=SJ',
          rating: 4.8,
          ...
          images: ['https://via.placeholder.com/300x200/2196F3/FFFFFF?text=Review+Photo'],
          categoryRatings: {
            'cleanliness': 5.0,
            'communication': 5.0,
            'location': 4.5,
        ...
        Review(
          ...
          userId: 'user3',
          userName: 'Mike Chen',
          userAvatar: 'https://via.placeholder.com/150/FF9800/FFFFFF?text=MC',
          rating: 4.0,
      ...
      '2': [
        Review(
          ...
          userId: 'user4',
          userName: 'Emma Davis',
          userAvatar: 'https://via.placeholder.com/150/E91E63/FFFFFF?text=ED',
          rating: 5.0,
          ...
          images: ['https://via.placeholder.com/300x200/4CAF50/FFFFFF?text=Review+Photo'],
          categoryRatings: {
            'cleanliness': 5.0,
            'communication': 5.0,
            'location': 5.0,
    ...
    return {
      'user2': [
        Review(
          ...
          userAvatar: 'https://via.placeholder.com/150/9C27B0/FFFFFF?text=PO',
          rating: 4.9,
      ...
      'user4': [
        Review(
          ...
          userAvatar: 'https://via.placeholder.com/150/FF5722/FFFFFF?text=BH',
          rating: 5.0,
