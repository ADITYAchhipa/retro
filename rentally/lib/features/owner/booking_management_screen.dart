...
class BookingManagementService extends StateNotifier<List<OwnerBooking>> {
  ...
  static final List<OwnerBooking> _mockBookings = [
    OwnerBooking(
      ...
      propertyImage: 'https://via.placeholder.com/300x200/4CAF50/FFFFFF?text=Property+1',
      guestId: '2',
      guestName: 'Sarah Johnson',
      guestAvatar: 'https://via.placeholder.com/150/2196F3/FFFFFF?text=SJ',
    ...
    OwnerBooking(
      ...
      propertyImage: 'https://via.placeholder.com/300x200/9C27B0/FFFFFF?text=Property+2',
      guestId: '3',
      guestName: 'Mike Chen',
      guestAvatar: 'https://via.placeholder.com/150/FF9800/FFFFFF?text=MC',
    ...
    OwnerBooking(
      ...
      guestAvatar: 'https://via.placeholder.com/150/E91E63/FFFFFF?text=EW',
